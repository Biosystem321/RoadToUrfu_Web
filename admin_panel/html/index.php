...
<body>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="http://roadtourfu.ai-info.ru/frontend/admin_panel/html/index.php?category=add" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="http://roadtourfu.ai-info.ru/frontend/admin_panel/html/index.php?category=edit&point=0" aria-expanded="false">
                                <i class="mdi mr-2 mdi-table-edit"></i><span class="hide-menu">Редактировать</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="http://roadtourfu.ai-info.ru/frontend/admin_panel/html/index.php?category=delete" aria-expanded="false"><i class="mdi mr-2 mdi-close-circle"></i><span
    ...
    elseif($_GET['category'] == "edit")
    {
        ...
        function LoadPoint($point_id) {
            ...
            echo '<p><input type="file" name="image0" value="Добавление фото" />Фотография №1</p>';
            echo '<p><input type="file" name="image1" value="Добавление фото" />Фотография №2</p>';
            echo '<p><input type="file" name="image2" value="Добавление фото" />Фотография №3</p>';            
        ...
        echo '<div class="wrapper fadeInDown">';
        echo '<div id="formContent">';
        echo '<form enctype="multipart/form-data" action="http://roadtourfu.ai-info.ru/frontend/admin_panel/html/update_point.php" method=post>';
        GetCategory($data_array[0]);
...
?>       
    ...
    <script>
        ...
        activities.addEventListener("change", function() {
            ...
            window.location.replace("http://roadtourfu.ai-info.ru/frontend/admin_panel/html/index.php?category=edit&point=" + value);
        });
    </script>
    </div>
