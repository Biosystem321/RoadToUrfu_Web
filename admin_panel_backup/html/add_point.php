...
function AddPoint($conn)
{
    ...
    $description_chinese = $_POST['description_ch'];
    $description_english = $_POST['description_eng'];
    ...
    INSERT INTO data_chinese (id, name, description)
        VALUES ('$inserted_id', '$name_chinese', '$description_chinese')";
    ...
    INSERT INTO data_english (id, name, description)
        VALUES ('$inserted_id', '$name_english', '$description_english')";
